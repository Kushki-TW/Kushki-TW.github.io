...
function oneTimePayv2() {
  ...
  $("#credit-card-form").submit(function (event) {
    ...
    if (validateCardInputs()) {
      ...
      /* Esta parte es reemplazada por la parte de abajo
        const kushki = new Kushki({
            merchantId: merchantKey, 
            inTestEnvironment: true,
          });
      */
      ...
      // Es reemplazada por esta parte
      /*    const kushkiOptions = {
            publicCredentialId: "d6b3e17702e64d85b812c089e24a1ca1", // This corresponds to the public credential of the merchant
            inTest: true
          }
      */
      ...
      /*
          ...
          //esta parte es nueva en Kushki.js v2 y vendría a reemplazar parte de la implementación del token en Kushki.js v1
          const options = {
            amount: {
              iva: 0,
              subtotalIva: totalG,
          ...
          const buildCardInstance = async () => {
            try {
              ...
              const cardInstance = await initCardToken(kushkiInstance, options)
            } catch (e) {
              console.error(e.message)
            }
          }
